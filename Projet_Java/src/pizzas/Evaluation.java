...
public class Evaluation {
    ...
    private String commentaire; // le commentaire laissé par le client avec la note
    ...
    public Evaluation(Client client, Pizza pizza, int note) {
        this(client, pizza, note, ""); // appele le constructeur original et insert un com vide
    }
